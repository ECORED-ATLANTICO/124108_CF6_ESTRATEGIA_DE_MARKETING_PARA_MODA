          ...
          .col-lg-10.mb-3.mb-lg-0
            .bloque-texto-b.color-secundario.p-4(data-aos="fade-up").mb-3
              .bloque-texto-b__texto
                i.fas.fa-quote-left
                h5.mb-0 Consiste en recopilar la información que generan los usuarios al visitar un sitio web e interactuar con él de diversas maneras. Posteriormente, analizamos todos estos datos para obtener #[em insights] que nos ayuden a mejorar e identificar a un público potencial. (p.17)
