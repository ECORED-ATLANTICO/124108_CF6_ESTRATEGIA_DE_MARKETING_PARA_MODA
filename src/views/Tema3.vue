  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Herramientas para analítica e informes de resultados
    ...
    .bg-full-width.bg-fondo-1
      .px-4.px-lg-5
        .row.justify-content-center.align-items-center.mb-5
          ...
          .col-lg-8
            p La analítica web debe ser un proceso articulado a los demás procesos empresariales, pues la información obtenida debe incorporarse en los procesos corporativos, por analítica digital, definido por Morales (2010):
            .row.align-items-center.bg-color-9.p-4
              .col-lg-auto.mb-3.mb-lg-0
                img.d-lg-flex.d-none(src="@/assets/curso/tema3/2.svg").mx-auto
              .col-lg
                p.mb-0 El conjunto de procesos que permiten gestionar el conocimiento que se obtiene a través de las herramientas de medición de los sitios web, obtener conclusiones y actuar en base a estas conclusiones, con el fin de alinear la estrategia de medición online con la estrategia de negocio. (p.17)
        
        p.mb-5 A su vez, Tomas, D. (2018) plantea que la analítica.
          ...
          .col-lg-10.mb-3.mb-lg-0
            .bloque-texto-b.color-secundario.p-4(data-aos="fade-up").mb-3
              .bloque-texto-b__texto
                i.fas.fa-quote-left
                h5.mb-0 Consiste en recopilar la información que generan los usuarios al visitar un sitio web e interactuar con él de diversas maneras. Posteriormente, analizamos todos estos datos para obtener insights que nos ayuden a mejorar e identificar a un público potencial. (p.17)
        ...
        .bloque-texto-g.color-secundario.bg-color-1.p-3.p-sm-4.p-md-5.mb-5
          ...
          .bloque-texto-g__texto.p-4
            p.mb-0 Ambas definiciones están relacionadas con estrategias de medición y métricas, que son usadas en las diferentes organizaciones para lograr su proceso misional como son:
          ...
          .col-lg-8.order-1.mb-3.mb-lg-0
            ul.lista-ul--color.ms-3
              li.mb-3.d-flex
                ...
                | Informes sobre cifras de tráfico y datos de los trayectos que realizan los usuarios en el mundo digital, ya sea en una página web, una aplicación o una red social.
              li.mb-3.d-flex
                i.fas.fa-chevron-circle-right.bg-color-18
                | Entender el comportamiento de clientes/usuarios.
              li.mb-3.d-flex
                i.fas.fa-chevron-circle-right.bg-color-18
                | Evaluar el rendimiento de las páginas web.
              li.mb-3.d-flex
                i.fas.fa-chevron-circle-right.bg-color-18
                | Tener claridad de la audiencia de los diferentes activos digitales de una compañía.
              li.mb-3.d-flex
                i.fas.fa-chevron-circle-right.bg-color-18
                | Reconocer los hábitos de consumo de nuestros visitantes.
              li.mb-3.d-flex
                i.fas.fa-chevron-circle-right.bg-color-18
                | Evaluar la notoriedad de una marca.
              li.mb-3.d-flex
                i.fas.fa-chevron-circle-right.bg-color-18
                | Controlar el SEO (Search Engine Optimization) para que el sitio empresarial se posicione de manera eficiente en los motores de búsqueda.
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-8
        ...
        .bg-color-25.tarjeta.px-5.py-4
          p.mb-0 Según el Observatorio Digital (2020) “Existen múltiples herramientas de analítica digital para web y para redes”, para más información lo invitamos a revisar su página web, dé clic en la imagen.
      ...
      .col-lg-8
        SlyderF.mb-5(columnas="col-lg-6 col-xl-6")
          ...
          .tarjeta.bg-color-white.box-shadow.p-4
            ...
            p.text-center Permite monitorear algunas redes como Facebook, Instagram, Twitter y Linkedin mediante gráficos evolutivos de un mes, se puede validar número de tweets por día, repercusiones, me gustas, publicaciones que funcionan, nuevos seguidores, y seguidores que se retiran.
          .tarjeta.bg-color-white.box-shadow.p-4
            .row.justify-content-center.mb-3
              .col-5
          ...
          .tarjeta.bg-color-white.box-shadow.p-4
            ...
            p.text-center Es una herramienta fácil que permite conocer nuevos seguidores, horas de mayor actividad y programar envíos directos, respuestas a tweets y monitorear hashtags.
          ...
          .tarjeta.bg-color-white.box-shadow.p-4
            ...
            p.text-center Aplicación que gestiona la promoción y seguimiento de las cuentas en Instagram, ofrece métricas de imágenes con seguimiento a las interacciones, comentarios visor de feed, hashtags más usados, horas, impacto alcance y sugerencias.
          .tarjeta.bg-color-white.box-shadow.p-4
            .row.justify-content-center.mb-3
              .col-5
    ...
    .bg-color-5.mb-5.p-4.tarjeta
      .row.align-items-center
        .col-lg-auto.mb-3.mb-lg-0.order-2
          img.d-none.d-lg-flex(src="@/assets/curso/tema3/17.png").mx-auto
        .col-lg.order-1
